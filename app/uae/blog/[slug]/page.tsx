            ...
            <div className="mt-16 pt-8 border-t border-charcoal-200">
              <div className="bg-gradient-to-br from-emerald-50 to-white p-8 rounded-xl border border-emerald-100">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/uae/contact" className="inline-block bg-emerald-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-emerald-500 transition-colors tracking-wide font-sans text-center">
                    Book Free Consultation
                  </Link>
                  <Link href="/uae/resources" className="inline-block border border-emerald-600 text-emerald-600 px-8 py-3 rounded-lg font-semibold hover:bg-emerald-50 transition-colors tracking-wide font-sans text-center">
                    View Free Resources
                  </Link>
                </div>
              </div>
